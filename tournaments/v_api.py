...
from tournaments.models import AdminFolder, UserFolder, ClubFolder
from tournaments.models import AdminArticle, UserArticle, ClubArticle, UserArticleParam
...
def POST_edit_folder(request, cur_user):
    ...
    if not util_check_access(cur_user, {
        'perms_user': ["tournaments.change_userfolder"], 
        'perms_club': ["tournaments.change_clubfolder"]
    }):
...
def POST_delete_folder(request, cur_user):
    ...
    try:
        ...
        pass
    if not util_check_access(cur_user, {
        'perms_user': ["tournaments.delete_userfolder"], 
        'perms_club': ["tournaments.delete_clubfolder"]
    }):
        return JsonResponse({"err": "Access denied.", "success": False}, status=400)
    c_folder = None
    res_data = ""
...
def POST_edit_article(request, cur_user):
    ...
    try:
        ...
        pass
    if not util_check_access(cur_user, {
        'perms_user': ["tournaments.change_userarticle"], 
        'perms_club': ["tournaments.change_clubarticle"]
    }):
        return JsonResponse({"err": "Access denied.", "success": False}, status=400)
    c_article = None
    c_folder = None
...
def POST_delete_article(request, cur_user):
    ...
    try:
        ...
        pass
    if not util_check_access(cur_user, {
        'perms_user': ["tournaments.delete_userarticle"], 
        'perms_club': ["tournaments.delete_clubarticle"]
    }):
        return JsonResponse({"err": "Access denied.", "success": False}, status=400)
    c_article = None
    res_data = ""
...
def GET_get_folders_all(request, cur_user):
    ...
    """
    if not util_check_access(cur_user, {
        'perms_user': ["tournaments.view_userfolder"], 
        'perms_club': ["tournaments.view_clubfolder"]
    }):
        return JsonResponse({"err": "Access denied.", "success": False}, status=400)
    res_exs = []
...
def GET_get_articles_all(request, cur_user):
    ...
    """
    if not util_check_access(cur_user, {
        'perms_user': ["tournaments.view_userarticle"], 
        'perms_club': ["tournaments.view_clubarticle"]
    }):
        return JsonResponse({"err": "Access denied.", "success": False}, status=400)
    res_exs = []
    # only admin folders temp:
