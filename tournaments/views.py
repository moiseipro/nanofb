...
import tournaments.v_api as v_api
...
def tournaments(request):
    ...
    Next arguments:\n
    * 'menu_tournaments' -> Html tag class: "active" for Sidebar.
    ...
    * 'ui_elements' -> List of UI elements registered in icons' system. Check Module.system_icons.views.get_ui_elements(request) for see more.
    ...
    if not util_check_access(cur_user[0], 
        {'perms_user': ["tournaments.view_userarticle"], 'perms_club': ["tournaments.view_clubarticle"]}
    ):
    ...
    return render(request, 'tournaments/base_tournaments.html', {
        'menu_tournaments': 'active',
