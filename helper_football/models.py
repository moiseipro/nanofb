...
class UserFolder(AbstractFolder):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='helper_football_userfolder_user')
    objects = models.Manager()
...
class ClubFolder(AbstractFolder):
    club = models.ForeignKey(Club, on_delete=models.CASCADE, null=True, blank=True, related_name='helper_football_clubfolder_club')
    objects = models.Manager()
...
class UserArticle(AbstractArticle):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='helper_football_userarticle_user')
...
class ClubArticle(AbstractArticle):
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, related_name='helper_football_clubarticle_user')
    club = models.ForeignKey(Club, on_delete=models.CASCADE, null=True, blank=True, related_name='helper_football_clubarticle_club')
...
class UserArticleParam(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='helper_football_userarticleparam_user')
