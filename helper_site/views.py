...
import helper_site.v_api as v_api
...
def helper_site(request):
    ...
    Next arguments:\n
    * 'menu_helper_site' -> Html tag class: "active" for Sidebar.
    ...
    * 'ui_elements' -> List of UI elements registered in icons' system. Check Module.system_icons.views.get_ui_elements(request) for see more.
    ...
    if not util_check_access(cur_user[0], 
        {'perms_user': ["helper_site.view_userarticle"], 'perms_club': ["helper_site.view_clubarticle"]}
    ):
    ...
    return render(request, 'helper_site/base_helper_site.html', {
        'menu_helper_site': 'active',
