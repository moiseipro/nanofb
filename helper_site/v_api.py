...
from helper_site.models import AdminFolder, UserFolder, ClubFolder
from helper_site.models import AdminArticle, UserArticle, ClubArticle, UserArticleParam
...
def POST_edit_folder(request, cur_user):
    ...
    if not util_check_access(cur_user, {
        'perms_user': ["helper_site.change_userfolder"], 
        'perms_club': ["helper_site.change_clubfolder"]
    }):
...
def POST_delete_folder(request, cur_user):
    ...
    try:
        ...
        pass
    if not util_check_access(cur_user, {
        'perms_user': ["helper_site.delete_userfolder"], 
        'perms_club': ["helper_site.delete_clubfolder"]
    }):
        return JsonResponse({"err": "Access denied.", "success": False}, status=400)
    c_folder = None
    res_data = ""
...
def POST_edit_article(request, cur_user):
    ...
    try:
        ...
        pass
    if not util_check_access(cur_user, {
        'perms_user': ["helper_site.change_userarticle"], 
        'perms_club': ["helper_site.change_clubarticle"]
    }):
        return JsonResponse({"err": "Access denied.", "success": False}, status=400)
    c_article = None
    c_folder = None
...
def POST_delete_article(request, cur_user):
    ...
    try:
        ...
        pass
    if not util_check_access(cur_user, {
        'perms_user': ["helper_site.delete_userarticle"], 
        'perms_club': ["helper_site.delete_clubarticle"]
    }):
        return JsonResponse({"err": "Access denied.", "success": False}, status=400)
    c_article = None
    res_data = ""
...
def GET_get_folders_all(request, cur_user):
    ...
    """
    if not util_check_access(cur_user, {
        'perms_user': ["helper_site.view_userfolder"], 
        'perms_club': ["helper_site.view_clubfolder"]
    }):
        return JsonResponse({"err": "Access denied.", "success": False}, status=400)
    res_exs = []
...
def GET_get_articles_all(request, cur_user):
    ...
    """
    if not util_check_access(cur_user, {
        'perms_user': ["helper_site.view_userarticle"], 
        'perms_club': ["helper_site.view_clubarticle"]
    }):
        return JsonResponse({"err": "Access denied.", "success": False}, status=400)
    res_exs = []
    # only admin folders temp:
