...
(function (global, factory) {
	...
	function build(opts) {
	  ...
	  svg.Element.image = function (node) {
	    ...
	    this.renderChildren = function (ctx) {
	      var x = this.attribute('x').toPixels('x');
	      var y = this.attribute('y').toPixels('y');
	      var width = this.attribute('width') ? this.attribute('width').toPixels('x') : this.attribute('data-width').toPixels('x');  // var width =  this.attribute('data-width').toPixels('x');
	      var height = this.attribute('height')? this.attribute('height').toPixels('y') : this.attribute('data-height').toPixels('y'); //var height = this.attribute('data-height').toPixels('y');
	...
	if (typeof CanvasRenderingContext2D != 'undefined') {
	  CanvasRenderingContext2D.prototype.drawSvg = function (s, dx, dy, dw, dh, opts) {
	    ...
	    s = xmlDoc.querySelector('svg');
	    if (s.id!="block"){
	        s.setAttribute("width",dw);
	        s.setAttribute("height",dh);
	    }
