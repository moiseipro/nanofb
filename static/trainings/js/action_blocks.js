async function ajax_blocks_action(method, data, action = '', id = '', func = '') {

    let url = "/trainings/api/blocks/"
    if(id !== '') url += `${id}/`
    if(func !== '') url += `${func}/`
...
$(window).on('load', function (){
    ...
    $('#blocks-form').on('submit', function(e) {
        ...
        ajax_blocks_action($(this).attr('method'), send_data, 'create block').then(function () {
