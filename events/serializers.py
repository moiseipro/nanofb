...
class AbstractMicrocyclesSerializer(serializers.ModelSerializer):
    ...
    calculate_days = serializers.SerializerMethodField()

    def get_calculate_days(self, microcycle):
    ...
    class Meta:
        fields = (
            'id', 'short_key', 'name', 'block', 'block_key', 'date_with', 'date_by', 'calculate_days'
        )
        datatables_always_serialize = ('id', 'short_key', 'name', 'block', 'block_key',)
...
class AbstractMicrocyclesUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        fields = (
            'name', 'short_key', 'block', 'block_key', 'date_with', 'date_by'
        )
